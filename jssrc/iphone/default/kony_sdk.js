 ...
 */
 ...
 kony.sdk.offline.saveUserAuthInformation = function(dbKey, authResponse) {
     ...
     var encryptedAuthResponse = kony.sdk.util.encryptText(stringifiedResponse, [kony.sdk.getDeviceId(), konyRef.mainRef.appKey, konyRef.mainRef.appSecret], "aes");
 ...
 kony.sdk.offline.getUserAuthInformation = function(dbKey) {
     ...
     if (!kony.sdk.isNullOrUndefined(encryptedAuthResponse)) {
         ...
         decryptedAuthResponse = kony.sdk.util.decryptText(encryptedAuthResponse, [kony.sdk.getDeviceId(), konyRef.mainRef.appKey, konyRef.mainRef.appSecret], "aes");
         if (kony.sdk.isNullOrUndefined(decryptedAuthResponse) || decryptedAuthResponse === '') {
             ...
             decryptedAuthResponse = kony.sdk.util.decryptText(encryptedAuthResponse, [konyRef.mainRef.appKey, konyRef.mainRef.appSecret], "aes");
             if (!kony.sdk.isNullOrUndefined(decryptedAuthResponse) && decryptedAuthResponse !== '') {
